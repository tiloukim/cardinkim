    ...
    <div className="admin-layout">
      <aside className="admin-sidebar">
        <div className="admin-sidebar-logo">
          <Link href="/"><img src="/logo.png" alt="Cardin Kim Closet" style={{ height: 112 }} /></Link>
      ...
      <main className="admin-main">
        <header className="admin-header">
          <h2 className="admin-page-title">
            {pathname === '/admin' ? 'Dashboard' : pathname === '/admin/orders' ? 'Orders' : pathname === '/admin/products' ? 'Products' : pathname === '/admin/customers' ? 'Customers' : pathname === '/admin/messages' ? 'Messages' : pathname === '/admin/settings' ? 'Settings' : pathname.startsWith('/admin/orders/') ? 'Order Detail' : 'Admin'}
          </h2>
